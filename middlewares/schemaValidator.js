 ...
 * TODO: Separate each schema validator to their own validator files. IE. centre, patient etc
 */
const schemaValidator = () => {
  // Validate the create user schema
  const createCentreSchema = (req, res, next) => {
      ...
      address: Joi.object()
        .keys({
          ...
          postalCode: Joi.string().required().messages({
            "string.base": `"postalCode" should be a type of 'text'`,
